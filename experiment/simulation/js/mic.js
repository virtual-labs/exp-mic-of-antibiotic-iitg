...
const animations = Array.from({length: 7}, (_, i) => `./json/mic_${i+1}.json`);
let animationInstance = null;
let currentProcedure = null;

// Create an array of all procedures
var allProcedures = [ 
    '1. Pipetting out Luria Broth in the Petri Plate',
    '2. From petri plate, pipette it into 12x10 well plate',
    '3. Adding antibiotic in the first row',
    '4. Serial dilution of Antibiotic',
    '5. Pipetting out E.coli in the Petri Plate and add to 12X10 well plate',
    '6. Transfer of Antibiotic to Ecoli',
